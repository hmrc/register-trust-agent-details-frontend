...
class RemoveDraftYesNoViewSpec extends YesNoViewBehaviours {
  ...
  "RemoveDraftYesNo View" must {
    ...
    behave like dynamicTitlePage(applyView(form), None, messageKeyPrefix, clientReferenceNumber)

    behave like pageWithBackLink(applyView(form))

    behave like yesNoPage(form, applyView, None, messageKeyPrefix, None, Seq(clientReferenceNumber))
